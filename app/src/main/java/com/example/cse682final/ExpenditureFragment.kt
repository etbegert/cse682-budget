...
class ExpenditureFragment(val accountInfo: AccountInfo) : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Adds a new expenditure to account info, updates the recycler view, and updates the fragment's display totals
    ...
    // Updates the displayed total values on this fragment
    fun updateDisplay() {
